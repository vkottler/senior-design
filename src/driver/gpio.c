...
int gpio_setClock(GPIO_TypeDef* port, bool state) {
	...
	switch ((uint32_t) port) {
		case GPIOA_BASE: bit_num = RCC_AHBENR_GPIOAEN_Pos; break;
		case GPIOB_BASE: bit_num = RCC_AHBENR_GPIOBEN_Pos; break;
		case GPIOC_BASE: bit_num = RCC_AHBENR_GPIOCEN_Pos; break;
		case GPIOD_BASE: bit_num = RCC_AHBENR_GPIODEN_Pos; break;
		case GPIOE_BASE: bit_num = RCC_AHBENR_GPIOEEN_Pos; break;
		case GPIOF_BASE: bit_num = RCC_AHBENR_GPIOFEN_Pos; break;
		case GPIOG_BASE: bit_num = RCC_AHBENR_GPIOGEN_Pos; break;
		case GPIOH_BASE: bit_num = RCC_AHBENR_GPIOHEN_Pos; break;
		default: return -1;
	}
