...
const GPIO GPIO_TABLE[] = {
	...
	/* Application SPI*/
	FILL_GPIO("SPI1_NSS",		GPIOA, 4, OUTPUT, HIGH_SPEED, NONE, true, SPI)
	...
	FILL_GPIO("GYRO_RST",		GPIOC, 2, OUTPUT, LOW_SPEED, NONE, true, SPI)
	FILL_GPIO("GYRO_INT1",		GPIOC, 0, INPUT, LOW_SPEED, NONE, true, SPI)
	FILL_GPIO("GYRO_INT2",		GPIOC, 1, INPUT, LOW_SPEED, NONE, true, SPI)
